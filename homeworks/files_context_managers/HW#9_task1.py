...
with open('task1.txt', 'r') as file:
    new_dict = {}
    for line in file:
        new_dict[line.strip()] = file.readline().strip()
    print(new_dict)

with open('task1.txt', 'r') as file:
    lines = file.readlines()
    new_dict = {}
    for number in range(0, len(lines)-1, 2):
        new_dict[lines[number].strip()] = lines[number+1].strip()
    print(new_dict)
...
with open(make_file('task1.txt')) as file:
    print("\n*** Task 1.2 ***\n", file.read())
...
with open(r'new_file.txt', 'r') as new_file:
    print(new_file.readlines())

with open(r'new_task1.txt', 'w') as new_file:
    for value in new_dict.values():
        new_file.write(value)
with open(r'new_task1.txt', 'r') as new_file:
    print(new_file.readlines())
